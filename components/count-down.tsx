...
export default function Countdown() {
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center h-screen bg-blue-100 dark:bg-gray-900">
      {/* Timer box container */}
      <div className="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-8 w-full max-w-md">
        {/* Title of the countdown timer */}
        <h1 className="text-2xl font-bold mb-4 text-black-800 dark:text-black-200 text-center">
          Countdown Timer<br></br>
          by <span className="text-2xl font-bold mb-4 text-blue-800 dark:text-gray-200 text-center">Mehak Hamid</span>
        </h1>
        ...
        <div className="flex items-center mb-6">
          <Input
            ...
            className="flex-1 mr-4 rounded-md border-blue-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200"
          />
          <Button
            onClick={handleSetDuration}
            variant="outline"
            className="bg-gray-300 dark:text-blue-200"
          >
            Set
          </Button>
        </div>
      
        <div className="text-6xl font-bold text-blue-800 dark:text-gray-200 mb-8 text-center">
          {formatTime(timeLeft)}
        </div>
        ...
        <div className="flex justify-center gap-4">
          <Button
            onClick={handleStart}
            variant="outline"
            className="bg-green-300 dark:text-white-200"
          >
          ...
          <Button
            onClick={handlePause}
            variant="outline"
            className="bg-blue-300 dark:text-white-200"
          >
            Pause
          </Button>
          <Button
